...
const NTP=[['pool.ntp.org','NTP Pool Global'],['time.google.com','Google Public NTP'],['time.cloudflare.com','Cloudflare Time'],['time.windows.com','Microsoft'],['time.apple.com','Apple'],['time.facebook.com','Meta'],['time.nist.gov','NIST (US)'],['europe.pool.ntp.org','Europe NTP Pool'],['asia.pool.ntp.org','Asia NTP Pool'],['north-america.pool.ntp.org','North America Pool'],['south-america.pool.ntp.org','South America Pool'],['africa.pool.ntp.org','Africa Pool'],['oceania.pool.ntp.org','Oceania Pool'],['time1.google.com','Google Node 1'],['time2.google.com','Google Node 2'],['time3.google.com','Google Node 3'],['time4.google.com','Google Node 4'],['custom','Custom']];
